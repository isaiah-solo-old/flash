 ...
 */
public class EditStackDialogFragment extends BaseDialogFragment {
    ...
    public void onCreate (Bundle savedInstanceState) {
        ...
        this.stackName = b.getString(this.ac.getStr(R.string.bundle_name));
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(inflater.inflate(R.layout.dialog_new_stack, null))
                .setTitle(getActivity().getResources().getString(R.string.dialog_editstack))
                .setPositiveButton(this.ac.getStr(R.string.dialog_positive),
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Stack stack = ac.findStack(stackName);
                                stack.setName(text);
